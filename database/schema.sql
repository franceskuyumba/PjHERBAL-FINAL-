-- ============================================================
-- AfyaPlus E-commerce — PostgreSQL schema
-- Alternative to backend/src/scripts/migrate.js (runs automatically).
-- Apply with: psql -U postgres -d afya_shop -f database/schema.sql
-- ============================================================
...
-- Seed data
INSERT INTO categories (slug, name, tagline, icon) VALUES
